...
rule grammy_cpoor:
	...
	shell:
		...
		then
			...
			mv {OUTPUT}{wildcards.project}/{wildcards.sample}/C_poor/tmp_{output.fa} {output.fa};
			mv {OUTPUT}{wildcards.project}/{wildcards.sample}/C_poor/tmp_{output.fasta} {output.fasta};
			mv {OUTPUT}{wildcards.project}/{wildcards.sample}/C_poor/tmp_{output.rdt} {output.rdt};
			mv {OUTPUT}{wildcards.project}/{wildcards.sample}/C_poor/tmp_{output.mtx} {output.mtx};
			mv {OUTPUT}{wildcards.project}/{wildcards.sample}/C_poor/tmp_{output.lld} {output.lld};
			mv {OUTPUT}{wildcards.project}/{wildcards.sample}/C_poor/tmp_{output.btp} {output.btp};
